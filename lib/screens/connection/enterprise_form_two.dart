...
class EntrepriseFormTwo extends StatefulWidget {
  const EntrepriseFormTwo({Key? key}) : super(key: key);

  @override
  State<EntrepriseFormTwo> createState() => EntrepriseFormTwoState();
}

class EntrepriseFormTwoState extends State<EntrepriseFormTwo> {
  //bool _enable = false;
  @override
