      ...
      children: [
        Query(
          ...
          builder: (QueryResult result, {refetch, fetchMore}) {
            ...
            DesertsList = result.data?['mealsByType'];
            //print(PlatsList);
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  DesertsList[index]['price'].toString() + "dt",
                                  style: GoogleFonts.roboto(
                                    textStyle: const TextStyle(
                                      fontSize: 20,
                                      fontWeight: FontWeight.w500,
